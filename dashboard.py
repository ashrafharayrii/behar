...
def get_logo_base64():
    ...
    logo_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'img.jpg')
...
def load_excel_data():
    ...
    candidate_paths = [
        os.path.join(_base, 'Olis.xlsx'),
        os.path.join(_base, 'oils.xlsx'),
        os.path.join(_base, 'Oils.xlsx'),
        os.path.join(_base, 'Demand.xlsx'),
    ]
